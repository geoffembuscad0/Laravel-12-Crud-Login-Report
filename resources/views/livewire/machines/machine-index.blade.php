<div>
    ...
    <div class="">
      <div class="flex items-center gap-2">
          <a href="{{ route('machines.create') }}" class="inline-flex items-center px-4 py-2 bg-gray-500 hover:bg-blue-700 text-white text-sm font-medium rounded-md shadow-sm">
            Add Machine
          </a>
      </div>
      {{-- @endcan --}}
      <table class="min-w-full w-3/4 justify-center divide-y divide-gray-200">
